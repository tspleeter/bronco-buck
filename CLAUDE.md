...
| G2 | Mane Style | V4 Regular (+$0), V5 Punk (+$3, **deactivated** July 2026 pending punk renders), V28 Long (+$3, **LIVE July 2026 for 8 colors: Ruby Red, Oxford White, Desert Sand, Velocity Blue, Shadow Black, Carbonized Gray, Eruption Green, Azure Gray** — active:true, gated per-color via `LONG_SUPPORTED_G1`; the other 3 colors hide the option until their sets land) |
...
- Mane style images: Punk (no renders yet); Long (V28 — **71 of 88 done**, all head-aligned to regmane; **8 colors LIVE**: Ruby Red / Oxford White / Desert Sand / Velocity Blue / Shadow Black / Carbonized Gray / Eruption Green / Azure Gray complete 8/8; Cactus Gray missing white-left; Cyber Orange / Robin's Egg Blue untouched; plus 3 provisional-slug colors brown/tan/sky_blue pushed but not G1-wired)
