...
- **Order (top→bottom):** Ruby Red, Oxford White, Velocity Blue, Cactus Gray, Shadow Black, Desert Sand, Cyber Orange, Azure Gray, Eruption Green, Robin's Egg Blue, Carbonized Gray.
- **Mane color (6 white / 5 black), alternating:** White (pops on dark/mid bodies): Ruby Red, Velocity Blue, Shadow Black, Cyber Orange, Eruption Green, Carbonized Gray. Black (pops on light bodies): Oxford White, Cactus Gray, Desert Sand, Azure Gray, Robin's Egg Blue.
- **Style (5 Long V28 / 6 Regular V4):** Long: Ruby Red, Cactus Gray, Shadow Black, Azure Gray, Eruption Green. Regular: Oxford White, Velocity Blue, Desert Sand, Cyber Orange, Robin's Egg Blue, Carbonized Gray. All four combos present: white/long ×3, white/reg ×3, black/long ×2, black/reg ×3.
