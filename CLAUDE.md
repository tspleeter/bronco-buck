...
| G2 | Mane Style | V4 Regular (+$0), V5 Punk (+$3, **deactivated** July 2026 pending punk renders), V28 Long (+$3, **deactivated** July 2026 — 46 of 88 renders done, pending full render set) |
...
- G2 V28 "Long" is a real product style (+$3), **deactivated** July 2026 pending its full render set. **Done (46 of 88):** Ruby Red, Oxford White, Desert Sand — **complete** (8 each); Velocity Blue / Shadow Black — black only (4 each); Cactus Gray — black complete + white 3/4 (**missing left**); Azure Gray — white complete + black 3/4 (**missing front**, the un-uploaded `Untitled_65`). **Still needed before relaunch:** white manes for Velocity Blue + Shadow Black (8); Cactus Gray white *left* (1); Azure Gray black *front* (1); all of Eruption Green, Cyber Orange, Carbonized Gray, Robin's Egg Blue (4 colors × 8 = 32). To relaunch: flip active:true and update MANE_STYLE_MAP V28→"long". Full set = 88 (11 colors × 4 views × 2 mane colors).
- **Held / unidentified colors (July 2026):** Long renders have arrived for **three** bodies that match none of the 11 configured G1 colors — all held pending Todd's ID (Ford name/code + G1 slot, like the Robin's Egg Blue add) before processing/pushing: (1) **charcoal/dark gray** (`Untitled_9..12`, 4 files); (2) **saddle/chocolate brown**, RGB ≈ (89,54,35), 8 files (`Untitled_53..60`, complete set); (3) **light tan/khaki**, RGB ≈ (193,165,128) — NOT Desert Sand (33 units off) — 6 files (`Untitled_69..76`: black complete, white front+left only); (4) **saturated sky-blue**, RGB ≈ (108,179,211) — NOT Robin's Egg (66 off) or Velocity Blue — 6 files (`Untitled_77..84`, incl. one `.png`: white complete, black front+back only). Identify uploaded colors by sampling the **plinth median RGB** and matching against reference `body_{color}_front_regmane_black.png` plinths (a good match is <~12 RGB units; azure/desert matched exactly, confirming no global render color-shift, so these three are genuinely new).
...
- Mane style images: Punk (no renders yet); Long (V28 — **46 of 88 done**: Ruby Red / Oxford White / Desert Sand complete; Velocity Blue + Shadow Black black-only; Cactus Gray missing white-left; Azure Gray missing black-front; still need blue+black white manes, cactus white-left, azure black-front, 4 untouched colors, plus 3 held unidentified colors) — builder UI exists, layers disabled until full sets arrive
