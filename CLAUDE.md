...
| G2 | Mane Style | V4 Regular (+$0), V5 Punk (+$3, **deactivated** July 2026 pending punk renders), V28 Long (+$3, **deactivated** July 2026 — 50 of 88 renders done, pending full render set) |
...
- G2 V28 "Long" is a real product style (+$3), **deactivated** July 2026 pending its full render set. **Done (50 of 88):** Ruby Red, Oxford White, Desert Sand — **complete** (8 each); Velocity Blue / Shadow Black / Carbonized Gray — black only (4 each); Cactus Gray — black complete + white 3/4 (**missing left**); Azure Gray — white complete + black 3/4 (**missing front**, the un-uploaded `Untitled_65`). All 50 are **head-aligned to the regmane** (not just plinth-aligned) — see head-alignment note in Image Processing. **Still needed before relaunch:** white manes for Velocity Blue + Shadow Black + Carbonized Gray (12); Cactus Gray white *left* (1); Azure Gray black *front* (1); all of Eruption Green, Cyber Orange, Robin's Egg Blue (3 colors × 8 = 24). To relaunch: flip active:true and update MANE_STYLE_MAP V28→"long". Full set = 88 (11 colors × 4 views × 2 mane colors).
